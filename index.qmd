...
- Data Science Tools in R and python (5 credits)

All courses offered in the Fall term and have no entry requirement.   
Data Science Concepts and Data Science Tools are co-requirements. 

The *concepts* treated in the lectures are applied with programming *tools* learned in the Tools course. Central to individual learning are *homework projects*.
...
Concepts: {{< var instructor.concepts >}}

Tools: {{< var instructor.tools >}}
